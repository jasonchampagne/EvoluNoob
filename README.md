...
<details>
    ...
    <ul>
        ...
        <li>Go</li>
        <li>Godot</li>
        <li>Hacking (à 100 000 vues sur la [vidéo d'intro](https://www.youtube.com/watch?v=IUjKepInQrM) OU si je deviens [Partenaire Twitch](https://jasonchampagne.fr/twitch))</li>
        <li>Haskell</li>
        <li>HTML/CSS</li>
        <li>Japonais</li>
        <li>Java</li>
